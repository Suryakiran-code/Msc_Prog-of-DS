...
# An algorithm is a finite set of instructions for accomplishing a task. Some examples of
# algorithms are sorting algorithms, searching algorithms, clustering algorithms, shortest path
# algorithms, DNA sequence alignment algorithms, convex hull algorithms, and encryption
# algorithms.

# Testing vs Debugging

# Testing – Process of finding bugs (errors) in software. Done manually by a tester or can be
# automated.

# Debugging – Process of fixing bugs found in the testing phase. The programmer is
# responsible for debugging and it can’t be automated.

#1.Using the Python Debugger (ipdb) in Spyder
...
#  frozenset is unordered, immutable
